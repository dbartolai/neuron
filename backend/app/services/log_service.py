...
class LogService:
    ...
    @staticmethod
    async def insert_message(db: asyncpg.Connection, thread_id: str, role: str, message: str) -> None:
        query = """
    ...
    @staticmethod
    async def get_messages_from_thread(db: asyncpg.Connection, thread_id: str, limit: int = 20) -> List[MessageLog]:
